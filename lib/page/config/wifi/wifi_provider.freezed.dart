...
class _$_WifiState implements _WifiState {
  const _$_WifiState({this.ssid, this.password});
  ...
  @override
  String toString() {
    return 'WifiState(ssid: $ssid, password: $password)';
  }
...
abstract class _WifiState implements WifiState {
  const factory _WifiState({final String? ssid, final String? password}) =
      _$_WifiState;
